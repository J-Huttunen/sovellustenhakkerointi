...
Tein muutokset tiedostoihin ajamalla terminaalissa "make", koska kansiossa oli valmiina tiedosto `Makefile`, jossa oli koodi `gcc passtr.c -o passtr`, joka käänsi ohjelman.
